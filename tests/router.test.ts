...
function fakeAdapter(name: "minimax" | "syntheticnew", response: ProviderResponse): ProviderAdapter {
  return {
    name,
...
function failingAdapter(name: "minimax" | "syntheticnew", error: Error): ProviderAdapter {
  return {
    name,
...
describe("createRouter", () => {
  it("routes to preferred provider", async () => {
    ...
    const tracker = new UsageTracker({ minimax: limits, syntheticnew: limits });
